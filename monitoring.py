...
class UnattendedMonitorDetector:
    def __init__(self, model_path=None, confidence_threshold=0.5):
        ...
        if model_path and os.path.exists(model_path):
            ...
            default_model_path = "models/yolo8x.pt" # Check if this model exists
            if os.path.exists(default_model_path):
                ...
                self.model = YOLO("models/yolo11x.pt") # Use nano version as a fallback
        # Set device
        ...
        self.monitor_class_ids = [62, 63] # Class ID for 'tvmonitor'
    ...
    def detect_objects(self, frame):
        ...
        Also tracks persons across frames using BoT-SORT.
        
        Args:
            frame: The input image frame (NumPy array).
        Returns:
            tuple: (list_of_monitor_boxes, list_of_person_boxes)
                   Each box is (x1, y1, x2, y2, confidence, track_id for persons).
        """
        monitors = []
        persons = []
        ...
        for result in results:
            ...
            for box in boxes:
                ...
                if confidence >= self.confidence_threshold:
                    ...
                    if x1 < x2 and y1 < y2:
                        # Check if this detection has a track_id
                        track_id = None
                        ...
                        if cls_id in self.monitor_class_ids:
                            ...
                            # For persons, include the track_id if available
    ...
    def check_person_proximity(self, monitor_bbox, persons_list):
        ...
        for person in persons_list:
            px1, py1, px2, py2, *_ = person  # Handle varying length person tuples
